...
const translations = {
  ...
  hu: {
    'username.prompt': 'Mit lássanak az emberek, amikor hívod őket?',
    ...
    'update.bannerDefault': 'Új verzió érhető el a patycord-hoz.',
    'update.available': 'A patycord {version} verziója elérhető (jelenleg {current} fut).',
    ...
    'sidebar.theirId': 'az ő azonosítója',
    ...
    'main.notInCall': 'Nem vagy hívásban — válassz egy barátot balra, és nyomj Hívást.',
    ...
    'toast.callFailed': 'A hívás {name} felhasználóval sikertelen: {error}',
    ...
    'toast.screenShareFailed': 'A képernyőmegosztás sikertelen: {error}',
    'toast.micFailed': 'A mikrofonhoz való hozzáférés sikertelen: {error} — ellenőrizd, hogy csatlakoztatva van-e a mikrofon, majd indítsd újra a patycordot',
    ...
    'log.ready': 'készen áll — nyomj Hívást egy barát mellett a csatlakozáshoz',
